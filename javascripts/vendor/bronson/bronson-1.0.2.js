  ...
  (function(root, factory) {
    ...
    Bronson = window.Bronson = {
      ...
      publish: function(event) {
        var subscriber, _args, _channel, _event, _event_array, _event_regex, _i, _len, _ref, _results, _subscribers, _topic;
        ...
        for (_i = 0, _len = _subscribers.length; _i < _len; _i++) {
          ...
          _results.push(subscriber.callback.apply(this, _args));
        }
        return _results;
      },
      subscribe: function(event, callback, context) {
        ...
        return this.events[_channel][_topic].push({
