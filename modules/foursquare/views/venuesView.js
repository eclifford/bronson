(function() {
  ...
  define(['marionette', 'modules/foursquare/views/venuesItemView', 'tpl!modules/foursquare/templates/venuesTemplate.tmpl'], function(Marionette, VenuesItemView, VenuesTemplate) {
    var VenuesView, _ref;
